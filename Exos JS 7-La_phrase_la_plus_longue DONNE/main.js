...
//initialise un index pour la phrase la plus longue à zero
let phraseLongue = 0;

//on parcours notre tableau avec une boucle for

    //si la longueur de la phrase du tableau est supérieur à l'ancienne plus longue phrase
    
        //on écrase l'index
        
        
//on affiche la phrase la plus longue et son nombre de charctères.
...
for(let i = 0; i < phrases.length; i++){
     ...
     if(phrases[i].length > phrases[phraseLongue].length){
         
        phraseLongue = i
     }
};

document.write(`<p>La phrase la plus longue est: ${phrases[phraseLongue]} Sa longueur est de ${phrases[phraseLongue].length} caractères!</p>`);